...
def randompass():
    ...
    random_num.seed()
    lower = ''.join(random_num.choice(string.ascii_lowercase) for x in range(6))
    upper = ''.join(random_num.choice(string.ascii_uppercase) for x in range(6))
    number = ''.join(random_num.choice(string.digits) for x in range(6))
    punct = ''.join(random_num.choice(string.punctuation) for x in range(6))
    p = lower + upper + number + punct
    return ''.join(random_num.sample(p, len(p)))
